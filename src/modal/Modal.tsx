        ...
        <div className={`relative w-full ${props.modalSize} max-h-full`}>
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className={`btn-container ${props.closeButtonPadding}`}>
              <button
                type="button"
                className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 ml-96 py-2.5 mr-0 mb-4 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
                onClick={props.onClose}
              >
                Close
              </button>
