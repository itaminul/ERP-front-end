...
const InventoryLeftSideBar = () => {
  ...
  return (
    <>
      <div
        className="flex fixed top-0  z-40 h-screen bg-white  dark:bg-gray-800 relative"
      ...
      >
        ...
        >
          <img
            src="arrow-icon.webp"
            className={`absolute cursor-pointer -right-3 top-4 w-10 border-2 border-gray-900 rounded-full ${!open && "rotate-180"
              }`}
            ...
            >
              <ul className="space-y-2 font-medium origin-left">
                ...
                <li>
                  ...
                  <ul
                    id="dropdown-example"
                    className={`py-2 space-y-2 ${!showDropDownMenu && "hidden"
                      }`}
                  >
