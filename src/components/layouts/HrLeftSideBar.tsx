                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            ...
                            <ul id="dropdown-example" style={show ? { display: "block" } : { display: 'none' }} className="">
                                <li>
                                    <Link to="/de-part-ment-set-up-for-emp-info" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                        Department
                                    </Link>
                                </li>
                            </ul>
